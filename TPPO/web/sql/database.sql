...
/*Триггер: при добавлении записи меняет флаг на занятость в расписании*/
GO
...
/*Триггер: при добавлении нового микрозайма меняется количество
оформленных микрозаймов у соответсвующего сотрудника*/
GO
...
/*Триггер: при добавлении выплаты меняется сумма выплат в микрозайме и сумма долга*/
GO
