...
echo GridView::widget([
    ...
    'columns' => [
        ...
        ['label' => 'Серия и номер паспорта', 'value' => 'client_passport'], ['label' => 'Дата рождения', 'value' => 'client_birthday'],
        ...
        ['label' => 'Заработная плата', 'value' => 'client_salary'], ['label' => 'Номер телефона', 'value' => 'client_number'], [
            ...
            'template' => '{view} {update} {add_loan} {link}',
            'buttons' => [
                'add_loan' => function ($url, $model) {
                    return Html::a(
